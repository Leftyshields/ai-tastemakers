...
|------------|---------|-------------------|
| EXP-20260701-landing-layout | 2026-08-01 | `SITE_LANDING_LAYOUT_V2=1` in `pages.yml` |
| EXP-20260716-firecrawl-enrich-skills | 2026-08-01 | `DIGEST_ENRICH_WEB_PROVIDER=firecrawl` + `FIRECRAWL_API_KEY` in `digest.yml` |
...
### EXP-20260701-landing-layout (Homepage layout v2) — **shipped 2026-08-01**
...
### EXP-20260716-firecrawl-enrich-skills (Firecrawl web enrich) — **shipped 2026-08-01**
