...
| NARR-1 | Ponytail narration (Skills) | **Treatment** | [EXP-20260802-ponytail-narration-skills](../data/experiments/EXP-20260802-ponytail-narration-skills.json) — first treatment digest 2026-08-17→2026-08-29 |
| RANK-2 | Soft-dedup diversity (Skills) | **Queued (#2)** | Baseline planned 2026-08-30 after ponytail treatment ends |
